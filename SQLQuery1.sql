...
--1.Utilice la función DATEDIFF para obtener la diferencia en días 
--entre OrderData y RequiredDate de la tabla orders.
...
--4.Mostrar la cantidad de pedidos realizados por un cliente de 
--la tabla orders en donde los pedidos sean mayores a 5 y menores a 10 
--(Muestre 3 resultados, el primero utilizando >=,<=; el segundo 
--utilizando BETWEEN y el tercero utilizando IN).
